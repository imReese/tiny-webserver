...
const char *error_401_form = "You must be authenticated to get the file.\n";
const char *error_402_title = "Payment Required";
const char *error_402_form = "You must pay for the file.\n";
...
const char *error_501_form = "The server does not support the functionality required to fulfill the request.\n";
const char *error_502_title = "Bad Gateway";
const char *error_502_form = "The server was acting as a gateway or proxy and received an invalid response from the upstream server.\n";
const char *error_503_title = "Service Unavailable";
const char *error_503_form = "The server is temporarily unable to service your request due to maintenance downtime or capacity problems. Please try again later.\n";
const char *error_504_title = "Gateway Time-out";
const char *error_504_form = "The server was acting as a gateway or proxy and did not receive a timely response from the upstream server.\n";
const char *error_505_title = "HTTP Version Not Supported";
const char *error_505_form = "The server does not support the HTTP protocol version used in the request.\n";
